            ...
            <div className="justify-between px-4 mx-auto lg:max-w-8xl md:items-center md:flex md:px-8">
                <div>
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <a href="#">
                            <Image className="h-20 w-auto xl:hidden " src={RECSAI_sm} alt=''/>
                            <Image className="h-32 w-auto hidden xl:block" src={RECSAI_xl} alt=''/>
                        </a>
                ...
                <div>
                    <div className={`flex-1 justify-self-center pb-5 mt-8 md:block md:pb-0 md:mt-0 ${navbar ? 'block' : 'hidden'}`}>
