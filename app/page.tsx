      ...
      <div className='text-black w-full px-4 mx-auto lg:max-w-8xl md:px-8 md:mb-20 mb-10 md:flex md:items-center'>
        <div className='md:w-8/12'>
          ...
          <p className='font-light'>
            ...
            advent of these models. This latest generation of AI models will be the initial focus of RECSAI. Through events 
            and publications, we seek to contribute to a better understanding of these models, the optimal legal environment,
            and possible avenues for international collaboration and regulation.
          </p>
        </div>
